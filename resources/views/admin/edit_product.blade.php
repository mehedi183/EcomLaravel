	...
	<div class="row-fluid sortable">
		<div class="box span12">
			...
			<div class="box-content">
				<form class="form-horizontal" action="{{route('update_product',$product->product_id)}}" method="post" enctype="multipart/form-data">
					{{ csrf_field() }}
				  <fieldset>
					...
					<div class="control-group hidden-phone">
					  ...
					  <div class="controls">
						<input class="cleditor" name="product_short_description" rows="2" value="{{$product->product_short_description}}" required=""></input>
					  </div>
					</div>         
					<div class="control-group hidden-phone">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" class="form-control" value="{{$product->product_size}}" name="product_size" required="">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text" class="form-control" value="{{$product->product_color}}" name="product_color" required="">
